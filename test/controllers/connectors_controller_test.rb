...
class ConnectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connector" do
    assert_difference('Connector.count') do
      post connectors_url, params: { connector: { description: @connector.description, name: @connector.name, source: @connector.source } }
    end
  ...
  test "should update connector" do
    patch connector_url(@connector), params: { connector: { description: @connector.description, name: @connector.name, source: @connector.source } }
