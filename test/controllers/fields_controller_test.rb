...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { definition: @field.definition, name: @field.name, type: @field.datatype } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { definition: @field.definition, name: @field.name, type: @field.datatype } }
